            ...
            {historial.map((item, index) => {
              ...
              return (
                <tr key={item.id} className="border-b hover:bg-gray-50">
                  <td className="p-2">{new Date(item.fecha_valoracion).toLocaleDateString()}</td>
                  <td className="p-2">{item.peso_kg} kg</td>
                  <td className="p-2 text-sm">{item.clasificacion_minsalud}</td>
                  <td className={`p-2 text-center font-bold ${tendencia.color}`}>
